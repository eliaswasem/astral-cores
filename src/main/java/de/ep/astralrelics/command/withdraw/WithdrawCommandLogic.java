package de.ep.astralrelics.command.withdraw;
...
public class WithdrawCommandLogic {
    ...
    /**
     * Processes the core extraction mechanics to pull an unequipped relic out of a data profile back to an item.
    ...
    public static int execute(CommandSourceStack source, ServerPlayer player, boolean isLeftSlot) {
        ...
        /* Requests the factory class to compile a relic item */
        ...
        source.sendSuccess(() -> Component.literal("§aSuccessfully withdrew " + relic.getName() + " back to your inventory."), true);
        return 1;
    }
}
