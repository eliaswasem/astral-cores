...
import de.ep.astralrelics.event.logic.RelicDeathLogic;
import de.ep.astralrelics.event.logic.RelicInteractLogic;
    ...
    public static void register() {
        ...
        ServerPlayConnectionEvents.JOIN.register(
                (handler, sender, server) -> {
                    AstralRelics.PLAYER_DATA.load(handler.player);
                }
        );
        ...
        ServerPlayConnectionEvents.DISCONNECT.register(
                (handler, server) -> {
                    AstralRelics.PLAYER_DATA.unload(handler.player);
                }
        );
        ...
        UseItemCallback.EVENT.register((player, level, hand) -> {
             ...
             */
            return RelicFactory.getRelicFromItem(stack)
